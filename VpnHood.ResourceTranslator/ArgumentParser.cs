...
internal class ArgumentParser
{
    ...
    public static void PrintHelp()
    {
        ...
        Console.WriteLine("  -e, --engine <name>        Translation engine: gemini or gpt (default: auto-detected from model)");
        ...
        Console.WriteLine("  vhtranslator -b locales/en.json -x custom-prompt.txt -m chatgpt-4");
        ...
        Console.WriteLine("  - Models containing 'gemini' use Gemini engine, others use ChatGPT");
